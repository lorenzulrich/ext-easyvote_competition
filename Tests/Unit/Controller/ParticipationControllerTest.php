...
class ParticipationControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	protected function setUp() {
		$this->subject = $this->getMock('Visol\\EasyvoteCompetition\\Controller\\ParticipationController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllParticipationsFromRepositoryAndAssignsThemToView() {
		...
		$allParticipations = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array(), array(), '', FALSE);

		$participationRepository = $this->getMock('Visol\\EasyvoteCompetition\\Domain\\Repository\\ParticipationRepository', array('findAll'), array(), '', FALSE);
	...
	public function createActionAddsTheGivenParticipationToParticipationRepository() {
		...
		$participationRepository = $this->getMock('Visol\\EasyvoteCompetition\\Domain\\Repository\\ParticipationRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenParticipationInParticipationRepository() {
		...
		$participationRepository = $this->getMock('Visol\\EasyvoteCompetition\\Domain\\Repository\\ParticipationRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenParticipationFromParticipationRepository() {
		...
		$participationRepository = $this->getMock('Visol\\EasyvoteCompetition\\Domain\\Repository\\ParticipationRepository', array('remove'), array(), '', FALSE);
