...
class CompetitionControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    {
        $this->subject = $this->getMock('Visol\\EasyvoteCompetition\\Controller\\CompetitionController',
    ...
    public function listActionFetchesAllCompetitionsFromRepositoryAndAssignsThemToView()
    {
        ...
        $allCompetitions = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', array(), array(), '',
            false);

        $competitionRepository = $this->getMock('Visol\\EasyvoteCompetition\\Domain\\Repository\\CompetitionRepository',
