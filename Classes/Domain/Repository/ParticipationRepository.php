...
class ParticipationRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	 ...
	 */
	public function findOneByCompetitionAndCommunityUser(\Visol\EasyvoteCompetition\Domain\Model\Competition $competition, \Visol\Easyvote\Domain\Model\CommunityUser $communityUser) {
		$query = $this->createQuery();
		$query->matching(
			$query->logicalAnd(
				$query->equals('competition', $competition),
	 ...
	 * @return bool
	 */
	public function updateCachedVotesAndCachedRankForCompetition(\Visol\EasyvoteCompetition\Domain\Model\Competition $competition) {
